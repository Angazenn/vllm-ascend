...
ge::graphStatus CompressorTiling::ConvertContext(gert::TilingContext &context, CompressorContext &compressorContext)
{
    ...
    compressorContext.batchedVerify = attrs->GetAttrPointer<bool>(BATCHED_VERIFY_ATTR_INDEX);
...
ge::graphStatus CompressorTiling::SetBaseInfo()
{
    ...
    baseParams_->batchedVerify = static_cast<uint32_t>(*context_->batchedVerify ? 1 : 0);
